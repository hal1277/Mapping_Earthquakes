...
let overlays = {
  ...
  "Earthquake Data": majorEarthquake
};
...
d3.json("https://earthquake.usgs.gov/fdsnws/event/1/query.geojson?starttime=2022-01-22%2000:00:00&endtime=2022-01-29%2023:59:59&minmagnitude=4.5&orderby=time").then(function(data) {
